...
Identify by endpoint: reads the identity the Receive Location's configuration names; a transport-layer identifier whose claim is inferred. A technology of
